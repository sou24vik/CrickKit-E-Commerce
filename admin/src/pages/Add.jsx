...
const Add = ({ token }) => {
  ...
  const [subCategory, setSubCategory] = useState("Equipment");
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      formData.append("name", name); // first "name" is fieldname and second one is value
    ...
    >
      ...
      <div>
        ...
        <div className="flex gap-3">
          ...
          {/* Custom sizes (Admin-added sizes) */}
          {sizes
